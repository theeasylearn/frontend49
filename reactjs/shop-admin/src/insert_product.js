						...
						<div className="card-body">
							<form id="productForm">
								<div className="row">
									...
									<div className="col-lg-6 mb-3">
										<label className="form-label">Name</label><input type="text" className="form-control"
											name="name" />
									</div>
								</div>
								<div className="row">
									<div className="col-lg-4 mb-3"><label className="form-label">Photo</label><input type="file"
								...
								<div className="row">
									<div className="col-lg-4">
										<label className="form-label">Weight</label><input type="text" className="form-control"
											name="weight" />
									</div>
									<div className="col-lg-4">
										<label className="form-label">Size</label><input type="text" className="form-control"
											name="price" />
									</div>
									<div className="col-lg-4">
