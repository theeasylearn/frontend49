...
class ViewOrder extends React.Component {
            ...
            if (error !== 'no') {
                ...
                if (response.data[1]['total'] === 0) {
                    ...
                    this.setState({
                        ...
                        this.setState({grandTotal:response.data[0]['amount']})
                    });
                }
            }
        }).catch((error) => {
    ...
    fetchItemDetail() {
        const { orderid } = this.props.params;
        const apiAddress = getBaseURL() + "order_details.php?orderid=" + orderid;
        let options = {
            url: apiAddress,
            method: 'get',
            responseType: 'json'
                                        ...
                                        <table className="table table-bordered table-sm table-striped">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td className="text-end">{this.state.grandTotal}</td>
                                                </tr>
                                            </tfoot>
                                        </table>
